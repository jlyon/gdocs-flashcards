        ...
        ['$stateProvider', '$urlRouterProvider',
            function ($stateProvider, $urlRouterProvider) {
                ...
                $stateProvider
                    ...
                    .state("site.settingsAnalytics", {
                        url: '/settings/analytics',
                        templateUrl: 'views/analytics/analyticsSettings.html',
                        auth: true,
                        /*resolve: {
                    ...
                    .state("site.analytics", {
                        ...
                        auth: true,
                        resolve: {
                            config: function ($stateParams, $rootScope, pcAnalytics, site) {
                                console.log({siteId: site._id});
                                return pcAnalytics.get({siteId: site._id}).$promise.then(function (data) {
                                    return data;
                                });
                            }
                        },
                        controller: function ($scope, $rootScope, $state, $filter, config, site) {
                            $scope.config = config;

                            if (!site.analytics || !site.analytics.view) {
                                $scope.demo = true;
                            }
                            ...
                            $scope.charts = {
                                'sessions': {
                                    query: {
                                        'ids': config.view_id, // The Demos & Tools website view.
